...
// apis 
import { getFormDetails, editForm } from '../../service/service'
// redux
            ...
            {data &&
                <Grid container className='mainWrapper' component={'form'} method='post' encType='multipart/form-data' onSubmit={handleSubmit}>
                    ...
                    <Grid item xs={12} className='submitButton'>
                        <Button type="submit" startIcon={<EditIcon />} variant='contained' >Update Form</Button>
                    </Grid>
                    {/* Submit Button */}
                </Grid>
            }
